...
<head>
    ...
    <title>Template Laravel 9</title>
</head>
                    ...
                    <div class="col-4 mt-5">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p><b>Nissan GT-R ( Gran Turismo–Racing ; kode model: R35 ; bahasa Jepang: 日産・GT-R; Nissan GT-R ) adalah mobil yang dibuat oleh merek Jepang Nissan sejak tahun 2007. Memiliki tata letak tempat duduk 2+2 dan dianggap sebagai mobil sport dan grand tourer . Mesinnya dipasang di tengah depan dan menggerakkan keempat roda .</b></p>
                                <a href="{{route ('template2.show', ['id' => $data->id])}}" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
                    </div>
                @endforeach
